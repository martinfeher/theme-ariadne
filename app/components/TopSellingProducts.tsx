...
const TopSellingProducts: React.FC = () => {
  const t = useTranslations('TopSellingProducts');
  ...
  const topSelling = useMemo(() => getTopSellingProducts(products), [products]);

  if (loadState === 'ok' && topSelling.length === 0) {
    return null;
  }
    ...
    <section className="relative bg-white py-6 lg:py-8">
      <div className="container mx-auto max-w-7xl px-4">
        <div className="mb-2 flex flex-col gap-4 sm:mb-6 lg:flex-row lg:items-end lg:justify-between">
          ...
          <Link
            href="/category/popular-products"
        ...
        {loadState === 'ok' && topSelling.length > 0 && (
