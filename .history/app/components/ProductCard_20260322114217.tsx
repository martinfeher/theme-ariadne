      ...
      >
        ...
        <Link href={`/product/${product.id}`}>
          <div className="relative aspect-square">
            ...
            />
            <button id="add-to-cart" className="flex items-center space-x-1 bg-green-500 text-white px-3 py-1.5 rounded hover:bg-green-600 transition-colors text-sm !z-[100]">
