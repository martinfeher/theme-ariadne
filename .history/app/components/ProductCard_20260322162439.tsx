      ...
      >
        ...
        <Link href={`/product/${product.id}`}>
          ...
          <div className="relative flex justify-end items-center -mt-[50px]">
            ...
            <button className="absolute top-0 right-[10px] h-[37px] w-[235px] flex items-center space-x-1 text-white px-1.5 py-1.5 mr-4 mb-4 transition-colors text-sm z-[100] cursor-pointer rounded-full" onClick={() => addToCart(product.id)}>
