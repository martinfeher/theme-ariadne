...
const ShoppingCartIcon: React.FC<Props> = ({ className, fill }) => (
    ...
    <g clipPath="url(#clip-shoppingcart)">
        ...
        <path d="M10.4,282a3.208,3.208,0,1,0,3.208,3.208A3.212,3.212,0,0,0,10.4,282Zm0,4.417a1.208,1.208,0,1,1,1.208-1.209A1.209,1.209,0,0,1,10.4,286.417Z" fill= transform="translate(0 -260)" />
