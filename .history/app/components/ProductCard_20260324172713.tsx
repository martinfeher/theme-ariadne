      ...
      >
        ...
        <Link href={`/product/${product.id}`}>
          ...
          <div className="relative flex justify-end items-center -mt-[50px]">
            <button
              className="flex items-center justify-center mr-[9px] mb-[10x] space-x-1 bg-green-500 text-white px-1.5 py-1.5 transition-colors text-sm z-100 cursor-pointer rounded-full"
              // className="flex items-center justify-center space-x-1 bg-green-500 text-white px-1.5 py-1.5 mr-4 mb-4 transition-colors text-sm z-100 cursor-pointer rounded-full"
              onClick={(e) => {
                e.preventDefault();
            ...
            >
              ...
              {productCartCounter > 0 && (
                <div className="w-6 h-6 text-[16px]">{productCartCounter}</div>
              )}
            </button>
            {productCartCounter > 0 && (
              <div>
                <div className="absolute top-0 right-[10px] h-[37px] w-[260px] bg-green-500 rounded-full"></div>
                <div className="absolute top-0 right-[10px] h-[37px] w-[238px] flex items-center space-x-1 text-white px-1.5 py-1.5 mr-4 mb-4 transition-colors text-sm z-100 cursor-pointer rounded-full"
                 onClick={(e) => {
                  e.preventDefault();
                }}
                ...
                >
                  ...
                  }}><IoTrashOutline className="w-6 h-6" /></button>
                </div>
              </div>
            )}
            {/* <div className="absolute top-0 right-[10px] h-[37px] w-[260px] bg-green-500 rounded-full"></div>
