      ...
      >
        ...
        <Link href={`/product/${product.id}`}>
          ...
          <div className="flex justify-end items-center -mt-[40px]">
            <button id="add-tocart-btn" className="flex items-center space-x-1 bg-green-500 text-white px-1.5 py-1.5 m hover:bg-green-600 transition-colors text-sm !z-[100] cursor-pointer rounded-full">
