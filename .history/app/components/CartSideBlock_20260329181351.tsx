...
const CartSideBlock: React.FC = () => {
  ...
  return (
    <button
      ...
      className="fixed right-0 top-1/2 z-[220] flex w-[4.75rem] -translate-y-1/2 flex-col overflow-hidden rounded-l-xl border border-r-0 border-gray-200 bg-white text-center shadow-md transition-shadow hover:shadow-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-green-500 focus-visible:ring-offset-2"
    >
