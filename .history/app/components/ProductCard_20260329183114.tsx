      ...
      >
        ...
        >
          ...
          >
            ...
            {productCartCounter > 0 && (
              <div>
                <div className="absolute top-0 right-[10px] h-[37px] w-[260px] bg-gray-200 rounded-full" />
                <div
                ...
                >
                  <button
                    ...
                    className="bg-green-500 -ml-2 w-8 h-8 rounded-full flex items-center justify-center cursor-pointer"
                  >
