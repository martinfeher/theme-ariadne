      ...
      >
        ...
        <Link href={`/product/${product.id}`}>
          ...
          <div className="relative flex justify-end items-center -mt-[50px]">
            <button
              className="flex items-center justify-center mr-[9px] mb-[10] space-x-1 bg-green-500 text-white px-1.5 py-1.5 transition-colors text-sm z-100 cursor-pointer rounded-full"
