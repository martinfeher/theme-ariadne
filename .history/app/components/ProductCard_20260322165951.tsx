          ...
          <div className="relative flex justify-end items-center -mt-[50px]">
            ...
            {clickAddToCart && (
              <div>
                ...
                <button className="absolute top-0 right-[10px] h-[37px] w-[238px] flex items-center space-x-1 text-white px-1.5 py-1.5 mr-4 mb-4 transition-colors text-sm z-[100] cursor-pointer rounded-full" onClick={() => removeFromCart(product.id)}>
