...
export const MOCK_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    organic: false,
    ...mockProductImage('broccoli.jpeg'),
  },
  {
    id: 35,
    ...
    vendor: 'Ariadne Foods',
    categories: ['all', 'vegetables'],
    description: 'Tender baby spinach leaves, perfect for salads, smoothies, and quick sautés.',
    organic: true,
    ...mockProductImage('spinach.jpeg'),
  },
  {
    id: 36,
  ...
  },
  {
    ...
    vendor: 'Ariadne Foods',
    categories: ['all', 'fruits'],
    description: 'Naturally ripened organic kiwis.',
    organic: true,
    ...mockProductImage('kiwi.jpg'),
  },
  {
    id: 18,
